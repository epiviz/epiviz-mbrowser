module.exports = {
  test1: async function test1(browser, baseUrl) {
    //--------first test ----------//
        ...
        await page.waitForTimeout(500)
          .then(async () => {
            ...
            const element = await page.evaluate(async () => {
              ...
              .then(async () => {
                const element = await page.waitForTimeout(100)
                  .then(async () => {
                    console.log('selet first MS');
                    const element = await page.evaluate(async () => {
                      const elements = document.querySelector("#measurement > epiviz-measurement-browser").shadowRoot.querySelector("#cardElem").shadowRoot.querySelectorAll("#cardContainer > paper-card");
                      elements[0].querySelector('paper-icon-button').click();
                      elements[1].querySelector('paper-icon-button').click();
                      return elements;
                    });
                  });
              })
              ...
              .then(async () => {
                const element = await page.waitForTimeout(500)
                  .then(async () => {
                    console.log('awaiterd for close button');
                    const element = await page.evaluate(async () => {
                      const element = document.querySelector('epiviz-measurement-browser').shadowRoot.querySelector('paper-dialog').querySelector('paper-button');
                      element.click();
                      return element;
                    });
                  });
              ...
              .then(async () => {
                const element = await page.waitForTimeout(100)
                  .then(async () => {
                    console.log('awaiterd for open again');
                    const element = await page.evaluate(async () => {
                      const element = document.querySelector('epiviz-measurement-browser').shadowRoot.querySelector('paper-button');
                      element.click();
                      return element;
                    });
                  });
